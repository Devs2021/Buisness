    ...
    <section className="pb-20 ">
      ...
      <div className="relative mx-auto h-max-w-max text-center">
        ...
        >
          ...
          <div className={`bg-white shadow-lg relative z-20  rounded-lg opacity-0 mt-6 transition-all duration-300 w-52 ${styles.clientBox}`}>
              <p className="font-secondary text-sm font-light">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequuntur pariatur necessitatibus.
              </p>
          </div>
        </motion.div>
        <motion.div
