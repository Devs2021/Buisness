...
import { itemSlideUp, slideToRight, slideUp, list } from "../../helpers/animation"
    ...
    return (
        <section className="pb-40 ">
           ...
           <div className="py-16 sm:px-10 px-2 bg-dark-blue">
            <ScrollReveal variants={slideUp} className="max-w-screen-xl mx-auto md:px-10 px-2">
            ...
            <div className="pt-20 grid lg:grid-cols-2 grid-cols-1 justify-center gap-8">
                <div className="lg:hidden">
                    ...
                    <ScrollReveal variants={slideToRight} custom={0.3} className={`${styles.about} relative w-max md:px-0 px-6 justify-self-center`}>
                        <Image
                            src={about}
                            width={495}
                            height={350}
                    ...
                    <ScrollReveal variants={list} custom={0.6} className="self-center">
                        ...
                        <motion.p variants={itemSlideUp} className="font-secondary font-light text-sm mb-6">
                        ...
                        <motion.button variants={itemSlideUp} className="rounded-lg bg-primary text-white fontmain capitalize px-8 py-2">read more</motion.button>
                    </ScrollReveal>
                </div>
            </div>
        </section>
