...
const Subscribe = () => {
    return (
        <ScrollReveal variants={slideUp} className={`text-center py-16 mb-20 md:px-8 px-2 rounded-lg ${styles.gradient}`}>
                    ...
                    <form action="" className="relative w-full">
                        <div className="w-full">
                            <input type="email" name="email" id="email" placeholder="email address for best offers" className="w-full rounded-full bg-white py-3 px-6 font-secondary text-black text-sm font-light" />
