    ...
    return (
        <section className="py-28 md:px-10 px-4">
            ...
            <div className="max-w-screen-lg mx-auto bg-white shadow-xl rounded-lg">
                ...
                <form action="" className="max-w-2xl mx-auto px-10 py-20">
                    <div className="grid sm:grid-cols-4 grid-cols-1   gap-6 items-center mb-4">
                    ...
                    <div className="grid sm:grid-cols-4 grid-cols-1  gap-6 items-center mb-6">
