    ...
    return (
        <section className="py-28 md:px-10 px-4">
            ...
            <div className="max-w-screen-lg mx-auto bg-white shadow-xl rounded-lg">
                ...
                <form action="" className="overflow-hidden max-w-2xl mx-auto px-10 pt-6 pb-20">
                    <ScrollReveal variants={slideUp} className="grid sm:grid-cols-4 grid-cols-1   gap-6 items-center mb-4">
                    ...
                    <ScrollReveal variants={slideUp} className="grid sm:grid-cols-4 grid-cols-1  gap-6 items-center mb-4">
                        ...
                        <label htmlFor="country" className="font-secondary text-sm sm:justify-self-center">Postal code</label>
                        <input type="text"  className="focus:outline-none px-3 rounded-full py-2 bg-gray-100 w-full" />
                    </ScrollReveal>
                    <ScrollReveal variants={slideUp} className="grid sm:grid-cols-4 grid-cols-1  gap-6 items-center mb-4">
                    ...
                    <ScrollReveal variants={slideUp} className="grid sm:grid-cols-4 grid-cols-1  gap-6 items-center mb-6">
