...
const Hero = () => {
    return (
        <section>
            ...
            <ScrollReveal custom={0.6} variants={list} className="pb-20 text-center max-w-screen-lg mx-auto">
                <motion.h2 variants={itemSlideUp} className="font-secondary font-semibold text-3xl mb-6">
