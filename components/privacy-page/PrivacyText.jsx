  ...
  return (
    <section className="py-20">
      <div className="max-w-screen xl-mx-auto md:px-10 px-4">
        ...
        <h3 className="font-main text-2xl text-dark-blue mb-4">
          1. Introduction
        </h3>
        <p className="font-secondary text-md leading-relaxed mb-4">
          Welcome to arxel. arxel (“us”, “we”, or “our”) operates mywebsite.com
          (hereinafter referred to as “Service”). Our Privacy Policy governs
          your visit to mywebsite.com, and explains how we collect, safeguard
          and disclose information that results from your use of our Service. We
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          SERVICE means the mywebsite.com website operated by arxel. PERSONAL
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          ...
          <ul className="font-semibold my-4 flex flex-col space-y-2 font-secondary">
          ...
          communications from us by following the unsubscribe link. Usage Data
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          arxel uses the collected data for various purposes:
          <ul className="font-semibold my-4 flex flex-col space-y-2 font-secondary">
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          ...
          outside Bénin and choose to provide information to us, please note
          that we transfer the data, including Personal Data, to Bénin and
          ...
          transfer. arxel will take all the steps reasonably necessary to ensure
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          ...
          <h4 className="font-secondary my-4 font-semibold font-md">
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          ...
          removed from our systems, please email us at contact@mywebsit.com. In
          ...
          Service without some necessary data. You have the right to complain to
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          ...
          <ul className="font-semibold my-4 flex flex-col space-y-2 font-secondary">
            ...
            <li>
              ...
              emailing us at contact@mywebsit.com.
            </li>
          </ul>
        ...
        <p className="font-secondary text-md leading-relaxed mb-4">
          ...
          requests and ask us: 0.1. What personal information we have about you.
          ...
          email: contact@mywebsit.com. Your data protection rights, described
        ...
        <h3 className="font-main text-2xl text-dark-blue mb-4">18. Payments</h3>
        <p className="font-secondary text-md leading-relaxed mb-4">
